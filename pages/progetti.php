        ...
        <nav class="navbar fixed-top navbar-light navbar-expand-md bg-light justify-content-left">
            ...
            <div class="navbar-collapse collapse justify-content-between align-items-center w-100" id="collapsingNavbar2">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link ncol" href="//codeply.com">News</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link ncol" href="//codeply.com">Progetti</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link ncol" href="//codeply.com">Donazioni</a>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link ncol" href="//codeply.com" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        Contattaci
                        </a>
                        <div class="nav-item dropdown-menu" href="//codeply.com" aria-labelledby="navbarDropdown">
                            <a class="nav-link dropdown-item ncol" href="//codeply.com">Chi siamo</a>
                            <a class="nav-link dropdown-item ncol" href="//codeply.com">Contatti</a>
                        </div>
                    </li>
                </ul>
            </div>
