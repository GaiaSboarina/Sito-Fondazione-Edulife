...
<html lang="en">
    ...
    <body>
        ...
        <!-- Logo f -->
        <div class="logo">
            <a href="index.php"><img src="media/img/effe.png" id="imgLogo"></a>
        </div>
                        ...
                        <form class="col-sm-12 col-md-4" action='pages/show.php' method='post'>
                            ...
                            <button  href='pages/show.php?table=progetto&id=<?= $array_news[$i]['id']?>'>
                                <div class='card'>
                                    ...
                                    <div class='card-body'>
                                        <h6 class='title'><?= corto($array_news[$i]['titolo'], 25) ?></h6>
                                        <p class='card-text'style='color:#000;'><?= corto($array_news[$i]['contenuto'], 75)?></p>
                                    </div>
                                </div>
                            </button>   
                        </form>
                        ...
                        <form class='col-sm-12 col-md-4' action='pages/show.php' method='post'>
                            ...
                            <button  href='pages/show.php?table=progetto&id=<?= $array_progetti[$i]['id']?>'>
                                <div class='card'>
                                    ...
                                    <div class='card-body'>
                                        <h6 class='title'><?= corto($array_progetti[$i]['titolo'], 25) ?></h6>
                                        <p class='card-text'style='color:#000;'><?= corto($array_progetti[$i]['contenuto'], 75)?></p>
                                    </div>
                                </div>
                            </button>   
                        </form>
